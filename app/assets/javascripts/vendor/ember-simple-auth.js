// Version: 0.0.3-7-g346afdb
// Last commit: 346afdb (2013-10-18 10:39:04 +0200)
...
Ember.SimpleAuth.setup = function(app, options) {
  ...
  this.serverSessionRoute = options.serverSessionRoute || '/api/session';
  ...
  Ember.$.ajaxPrefilter(function(options, originalOptions, jqXHR) {
    if (!jqXHR.crossDomain && !Ember.isEmpty(session.get('authToken'))) {
      jqXHR.setRequestHeader('Authorization', ''+ session.get('authToken') + '');
    }
  });
};
